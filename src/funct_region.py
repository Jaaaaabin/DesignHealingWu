...
#     # split according to valid/invalid
...
#     bad_X_pca_y, good_X_pca_y = X_pca_y[indices_invalid], X_pca_y[indices_valid] 
#     bad_X_pca_y_colors, good_X_pca_y_colors = colors[indices_invalid], colors[indices_valid]

#     # plot
#     ax2.scatter(
#         bad_X_pca_y[:,0], bad_X_pca_y[:,1], c=bad_X_pca_y_colors,
#         marker=".", lw=0, s=15, alpha=0.75,
#         label='invalid designs',
#         )# bad points

#     ax2.scatter(
#         good_X_pca_y[:,0], good_X_pca_y[:,1], c=good_X_pca_y_colors,
#         marker="+", lw=1.5, s=15, alpha=0.75,
#         label='valid designs',
#         )# good points
