...
from src.tempo.funct_classifier import KMeans_clusterings

from src.tempo.funct_svm import evaluateLinearSVC_prediction, evaluateLinearSVC_decision, displaySVC, displaySVCinPC, stnd_nrml
...
# # okokokokokokokokokokokokokokokokokokokokokokokokokokok
# # Sub Section 4. cross_val_score for SVM using multiple folds..with <sklearn.model_selection.KFold>
